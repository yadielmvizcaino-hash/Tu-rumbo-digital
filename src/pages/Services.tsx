    ...
    <>
      ...
      >
        <header className="mb-16">
          <motion.span variants={itemVariants} className="text-[#d4ff00] font-bold text-lg uppercase tracking-[0.2em] mb-4 block">OUR ARSENAL</motion.span>
          <motion.h1 variants={itemVariants} className="text-6xl md:text-8xl font-black uppercase leading-none tracking-tighter">SERVICIOS <br/><span className="text-[#d4ff00] italic">RADICALES</span></motion.h1>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <motion.div variants={itemVariants} className="border-2 border-zinc-700 p-10 hover:border-[#d4ff00] transition-colors hard-shadow">
